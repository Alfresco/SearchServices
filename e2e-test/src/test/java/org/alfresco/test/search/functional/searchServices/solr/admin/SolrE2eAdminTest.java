...
public class SolrE2eAdminTest extends AbstractE2EFunctionalTest
{
    ...
    public void testNodeReport() throws Exception
    {
        ...
        String report = response.getResponse().body().jsonPath().get("report").toString();
    ...
    {
        RestResponse response = restClient.withSolrAdminAPI().getAction("report");
     ...
     * @throws Exception
     */
    @Test(priority = 13, groups = { TestGroup.ASS_SHARDING, TestGroup.ASS_SHARDING_DB_ID_RANGE })
     ...
     * @throws Exception
     */
    @Test(priority = 15, groups = { TestGroup.ASS_SHARDING, TestGroup.ASS_SHARDING_DB_ID_RANGE })
    ...
    public void testFix() throws Exception
    {
        ...
        String txToReindex = response.getResponse().body().jsonPath().get("action.txToReindex").toString();
        Assert.assertNotNull(txToReindex);
        
        String aclChangeSetToReindex = response.getResponse().body().jsonPath().get("action.aclChangeSetToReindex").toString();
        Assert.assertNotNull(aclChangeSetToReindex);
