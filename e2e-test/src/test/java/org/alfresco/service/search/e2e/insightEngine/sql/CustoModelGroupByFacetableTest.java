...
public class CustoModelGroupByFacetableTest extends AbstractSearchServiceE2E {
    ...
    public void initDataModel()throws Exception{
        ...
        cmisApi.authenticateUser(testUser).usingSite(testSite).usingResource(testFolder)
                .createFile(customFile2, properties, VersioningState.MAJOR).assertThat().existsInRepo();
        ...
        cmisApi.authenticateUser(testUser).usingSite(testSite).usingResource(testFolder)
                .createFile(customFile3, properties, VersioningState.MAJOR).assertThat().existsInRepo();
    ...
    public void testGroupByFacetableModel() throws Exception{
...
//        sqlRequest.setLimit(10);
    ...
    @Test(priority = 1, groups = { TestGroup.INSIGHT_10 })
    public void testGroupByFacetableModelInverted() throws Exception{
        SearchSqlRequest sqlRequest = new SearchSqlRequest();
