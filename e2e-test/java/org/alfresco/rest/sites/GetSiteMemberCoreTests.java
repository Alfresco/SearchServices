...
public class GetSiteMemberCoreTests extends RestTest
{
    ...
    public void getSiteMemberOfInexistentSite() throws Exception
    {
        ...
        restClient.assertStatusCodeIs(HttpStatus.NOT_FOUND)
            .assertLastError().containsSummary(String.format(ErrorModel.RELATIONSHIP_NOT_FOUND, consumer.getUsername(), invalidSite.getId()));
    }
    ...
    public void getSiteMemberForNonSiteMember() throws Exception
    {
        ...
        restClient.assertStatusCodeIs(HttpStatus.NOT_FOUND)
            .assertLastError().containsSummary(String.format(ErrorModel.RELATIONSHIP_NOT_FOUND, nonMember.getUsername(), siteModel.getId()));
    }
    ...
    public void getSiteMemberForEmptySiteId() throws Exception
    {
        ...
        restClient.assertStatusCodeIs(HttpStatus.NOT_FOUND)
            .assertLastError().containsSummary(String.format(ErrorModel.RELATIONSHIP_NOT_FOUND, consumer.getUsername(), emptySite.getId()));
    }
