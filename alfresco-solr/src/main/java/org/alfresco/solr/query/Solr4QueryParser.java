...
public class Solr4QueryParser extends QueryParser implements QueryConstants
{
     ...
     * @throws ParseException
     */
    private Query createFingerPrintQuery(String field, String queryText, AnalysisMode analysisMode, LuceneFunction luceneFunction) throws IOException, ParseException
    {
        ...
        SolrInputDocument solrDoc = SolrContentStore.retrieveDocFromSolrContentStore(AlfrescoSolrDataModel.getTenantId(TenantService.DEFAULT_DOMAIN), Long.parseLong(parts[0]));
        if (solrDoc != null)
        {
	...
	/**
     * @param field
     * @param fixedTokenSequences LinkedList<LinkedList<PackedTokenAttributeImpl>>
     * @return Query
     */
	...
	protected void addLocaleSpecificUntokenisedMLOrTextFunction(String expandedFieldName, PropertyDefinition pDef, String queryText, LuceneFunction luceneFunction, Builder booleanQuery,
	...
	protected void addLocaleSpecificUntokenisedTextRangeFunction(String expandedFieldName, PropertyDefinition pDef, String lower, String upper, boolean includeLower, boolean includeUpper,
			LuceneFunction luceneFunction, Builder booleanQuery, Locale locale, IndexTokenisationMode tokenisationMode) throws ParseException
	{
	...
	protected void addMLTextAttributeQuery(String field, PropertyDefinition pDef, String queryText, SubQuery subQueryBuilder, AnalysisMode analysisMode, LuceneFunction luceneFunction,
			String expandedFieldName, PropertyDefinition propertyDef, IndexTokenisationMode tokenisationMode, Builder booleanQuery,
	...
	private void addMLTextOrTextAttributeQuery(String field, PropertyDefinition pDef, String queryText, SubQuery subQueryBuilder, AnalysisMode analysisMode, LuceneFunction luceneFunction,
			String expandedFieldName, IndexTokenisationMode tokenisationMode, Builder booleanQuery, Locale locale) throws ParseException
	{
	...
	private void addLocaleSpecificMLOrTextAttribute(PropertyDefinition pDef, String queryText, SubQuery subQueryBuilder, AnalysisMode analysisMode, LuceneFunction luceneFunction,
			Builder booleanQuery, Locale locale, String textFieldName, IndexTokenisationMode tokenisationMode, IndexTokenisationMode preferredTokenisationMode)
					throws ParseException
	{
	...
	protected void addTextRange(String field, PropertyDefinition pDef, String part1, String part2, boolean includeLower, boolean includeUpper, AnalysisMode analysisMode, String fieldName,
			PropertyDefinition propertyDef, IndexTokenisationMode tokenisationMode, Builder booleanQuery, Locale locale) throws ParseException, IOException
	{
		switch (tokenisationMode)
		{
		case BOTH:
	...
	private void addLocaleSpecificTextRange(String expandedFieldName, PropertyDefinition pDef, String part1, String part2, boolean includeLower, boolean includeUpper, Builder booleanQuery,
	...
	protected void addTextSpanQuery(String field, PropertyDefinition pDef, String first, String last, int slop, boolean inOrder, String expandedFieldName, IndexTokenisationMode tokenisationMode,
			Builder booleanQuery, Locale locale)
	{
