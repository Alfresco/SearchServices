 ...
 */
public class TestDataLoader extends AbstractAlfrescoSolrTests implements AlfrescoSolrConstants
{
    ...
    private static  Map<QName, PropertyValue> getOrderProperties()
    {
        ...
        testProperties.put(ORDER_LOCALISED_TEXT, new StringPropertyValue(orderLocalisedNames[orderTextCount]));
