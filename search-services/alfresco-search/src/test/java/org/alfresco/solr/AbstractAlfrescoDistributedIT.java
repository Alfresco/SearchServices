...
public abstract class AbstractAlfrescoDistributedIT extends SolrTestCaseJ4
{
    ...
    public class JettyServerRule extends ExternalResource
    {
         ...
         * @param numShards
         */
        public JettyServerRule(int numShards, AbstractAlfrescoDistributedIT testClass)
        {
         ...
         * @param numShards
         */
        public JettyServerRule(int numShards, AbstractAlfrescoDistributedIT testClass, Properties solrcoreProperties)
        {
            this.serverName = testClass.getClass().getSimpleName();
            coreNames = new String[]{DEFAULT_TEST_CORENAME};
            this.numShards = numShards;
